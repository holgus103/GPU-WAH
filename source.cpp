...
//				unsigned int* decompressed = decompress(compressed, compressedSize, &decompressedSize, orderingArray, blockCount, &d_transferToDevice, &d_decompression, &d_transferFromDevice);
